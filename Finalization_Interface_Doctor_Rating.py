...
def translate_text(text, language):
    translations = {
        "English": {
            ...
            "Modified Question": "Modified Question",
            "Modified Answer": "Modified Answer",
            "Rate the modified answer": "Rate the modified answer",
            "Your Answer on the modified prompt (The answer supposed to be)": "Your Answer on the modified prompt (The answer supposed to be)",
        ...
        "Bahasa Indonesia": {
            ...
            "Modified Question": "Pertanyaan yang Dimodifikasi",
            "Modified Answer": "Jawaban yang Dimodifikasi",
            "Rate the modified answer": "Beri nilai jawaban yang dimodifikasi",
            "Your Answer on the modified prompt (The answer supposed to be)": "Jawaban Anda pada prompt yang dimodifikasi (Jawaban seharusnya)",
            ...
            "Enter your response to the prompt": "Masukkan jawaban Anda untuk prompt",
...
def render_sign_up():
    ...
    if st.button(translate_text("Sign Up", st.session_state.language), key="sign_up_button"):
        if not name or not username or not password:
            ...
            st.success(f"{translate_text('Welcome', st.session_state.language)}, {name}!")
...
def render_phase_1():
    ...
    st.info(f"**{translate_text('Example of the Scenario', st.session_state.language)}:**  {selected_scenario['scenario']}")
...
def render_phase_2():
    ...
    with st.container():
        st.write(f"**{translate_text('Original Question', st.session_state.language)}:** {prompt['scenario']}")
        st.write(f"**{translate_text('Original Answer', st.session_state.language)}:** {prompt['answer']}")
        ...
        st.write(f"**{translate_text('Modified Question', st.session_state.language)}:** {prompt['modified_question']}")
        st.write(f"**{translate_text('Modified Answer', st.session_state.language)}:** {prompt['modified_answer']}")
        rating_mod = st.slider(translate_text('Rate the modified answer', st.session_state.language), 1, 5, key=f"rating_mod_{prompt['scenario']}")
        response_mod = st.text_area(translate_text("Your Answer on the modified prompt (The answer supposed to be)", st.session_state.language), key=f"response_mod_{prompt['scenario']}")
...
def render_phase_3():
    ...
    st.info(f"**{translate_text('Example of the Scenario', st.session_state.language)}:** {prompt['scenario']}")
